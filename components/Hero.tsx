        ...
        <div className="relative">
          <div className="section-card overflow-hidden">
            ...
            <div className="p-5 md:p-6 space-y-3">
              ...
              <h2 className="text-lg md:text-xl font-semibold text-white md:text-slate-900">
                Evaluaciones, audífonos y soluciones para tu audición en un solo
                lugar.
              </h2>
              <div className="flex flex-wrap gap-4 text-xs text-slate-100 md:text-slate-500">
                <div>
                  <p className="font-semibold text-white md:text-brand-primary">
                    Dirección
                  </p>
                  <p>{contact.address}</p>
                </div>
          ...
          <div className="absolute -bottom-4 -right-2 md:-right-6">
            <div className="rounded-2xl bg-white/90 px-4 py-3 shadow-soft border border-slate-100 text-xs md:text-sm flex items-center gap-3">
